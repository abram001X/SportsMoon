...
export function Inicio({ homeApi, isLoad }) {
  return (
    <>
                ...
                return (
                  <section className="news-child-cont_news white" key={j}>
                    <section className="cont_details-child">
                      <img
                        className="img_icon_news"
                        src={element.source_icon}
                        alt=""
                      />
                      <a href={element.source_url} className="a-news">
                        {element.source_id.toUpperCase()}.COM
                      </a>
                    </section>
                    <a href={element.source_url} className="news-child">
                      <img
                        className="img-news-child"
                      ...
                      <section className="hp-news-child">
                        <h3>{element.title}</h3>
                        <br />
                        <p className="child-news-p">
                          {element.description.slice(
                            0,
                            element.description.lastIndexOf('appeared')
                          )}
                          ...
                        </p>
                      </section>
